            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="title-repair">
                        <p>Ремонт кофемашин <span class="wmf wmf_red">WMF</span> в Украине с гарантией</p>
                    </div>
                </div>
                <div class="col-lg-5">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="section-description">
                        <p class="descr">Компания Coffee Machine Service – официальный партнёр ТМ WMF в Украине. Мы обеспечиваем качественный ремонт кофемашин сертифицированными специалистами. Мы предоставляем гарантию на узлы, которые были заменены или отремонтированы. Капитальный ремонт кофемашин обеспечивает гарантию 30000 порций или 1 год на работу всего суперавтомата</p>
                    </div>
                </div>
            </div>
        </div>
