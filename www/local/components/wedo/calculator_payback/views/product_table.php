...
<div class="collapse show" id="open-table-calculate">
    <div class="card card-body custom-card">
        <div class="wrapp-table">
            ...
            <div class="col-table"><p>Цена реализации напитка (грн)</p> <div><?=$arResult['priceSale']?></div></div>
            ...
            <div class="col-table"><p>Маржинальный доход в месяц (грн)</p> <div><span id=""><?=$arResult['marga']?></span></div></div>
            <div class="col-table"><p class="bold-col-table" >Срок окупаемости (месяцев)</p> <div  class="bold-col-table" id="paybackPeriodTable"><?=$arResult['paybackPeriod']?></div></div>
        </div>
    </div>
</div>